...
public class ControllerImpl implements Controller {
    ...
    public String addPlayer(String fieldName, String playerType, String playerName, String nationality, int strength) {
        ...
        boolean menPlaysOnNaturalGras = player.getClass().getSimpleName().equals("Men") && fieldName.equals("NaturalGras");
        boolean womenPlaysOnArtificialTurf = player.getClass().getSimpleName().equals("Women") && fieldName.equals("ArtificialTurf");

        if (menPlaysOnNaturalGras || womenPlaysOnArtificialTurf) {
